...
def get_inventory_summaries(
    ...
    granularity_type: Annotated[
        str, "Type of granularity: 'Marketplace' or 'ASIN'"
    ] = "Marketplace",
    granularity_id: Annotated[
        str, "ID for the granularity type (marketplace ID or ASIN)"
    ] = "",
    start_date: Annotated[
        str, "ISO 8601 date for inventory data start (optional)"
    ] = "",
    seller_skus: Annotated[
        str, "Comma-separated list of seller SKUs to filter (optional)"
    ] = "",
    ...
    try:
        ...
        for item in inventory_data:
            formatted_item = {
                ...
                "reservedQuantity": item.get("inventoryDetails", {}).get("reservedQuantity", {}).get("totalReservedQuantity", 0),
                "inboundQuantity": {
